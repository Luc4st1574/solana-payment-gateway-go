...
const (
	// Label holds the string label denoting the paymentverifications type in the database.
	...
	FieldStatus = "status"
	// FieldAccessGranted holds the string denoting the access_granted field in the database.
	FieldAccessGranted = "access_granted"
	// FieldCreatedAt holds the string denoting the created_at field in the database.
	FieldCreatedAt = "created_at"
	// EdgeUser holds the string denoting the user edge name in mutations.
	EdgeUser = "user"
	// Table holds the table name of the paymentverifications in the database.
	Table = "payment_verifications"
	// UserTable is the table that holds the user relation/edge.
	UserTable = "payment_verifications"
...
// Columns holds all SQL columns for paymentverifications fields.
var Columns = []string{
	FieldID,
	FieldUserID,
	FieldWalletAddress,
...
var (
	...
	// DefaultAccessGranted holds the default value on creation for the "access_granted" field.
	DefaultAccessGranted bool
...
func StatusValidator(s Status) error {
	...
	case StatusPending, StatusVerified, StatusFailed:
		return nil
	default:
		return fmt.Errorf("paymentverifications: invalid enum value for status field: %q", s)
	}
}

// OrderOption defines the ordering options for the PaymentVerifications queries.
...
// ByAccessGranted orders the results by the access_granted field.
func ByAccessGranted(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAccessGranted, opts...).ToFunc()
}
